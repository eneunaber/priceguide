   ...
   private function loadStats(&$players, $dataset, $playerType)
   {
      switch ($dataset)
      {
         ...
         case "14Z":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2014BattingZeile.csv", "r");
            }
            else
            {
               $handle = fopen("stats/2014PitchingZeile.csv", "r");
            }
            break;
         case "15E":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2015BattingSteamer.csv", "r");
            }
            else
            {
               $handle = fopen("stats/2015PitchingSteamer.csv", "r");
            }
            break;
         case "15Z":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2015BattingZeile.csv", "r");
            }
            else
            {
         ...
         case "15S":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2015Batting.csv", "r");
            }
            else
            {
               $handle = fopen("stats/2015Pitching.csv", "r");
            }
            break;            
         case "16E":
            if ($playerType == "Hitters")
        ...
        case "17S":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2017Batting.csv", "r");
            }
            else
            {
               $handle = fopen("stats/2017Pitching.csv", "r");
            }
            break;                      
         case "18E":
            if ($playerType == "Hitters")
        ...
        case "18S":
            if ($playerType == "Hitters")
            {
               $handle = fopen("stats/2018Batting.4.15.csv", "r");
            }
            else
            {
               $handle = fopen("stats/2017Pitching.4.15.csv", "r");
            }
            break;              
         default:
            if ($playerType == "Hitters")
