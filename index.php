...
<div class="item_head_wide">The Fantasy Baseball Price Guide - NEW (2)</div>
<div class="item_wide">
...
<?php
   if ($customDataset)
   {
      ...
      print "<option value=\"17A\">2017 ATC</option>";
   }
   else
   {
	  print "<option value=\"17A\" selected=\"selected\">2017 ATC</option>";
   }
?>                     
   ...
   <option value="14Z">2014 Zeile</option>                 
